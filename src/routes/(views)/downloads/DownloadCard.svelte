...
<div class="t-mb-3">
	<div
		class="t-bg-gradient-to-r t-from-[#F94646] t-to-[#44835C]  lg:t-h-24 t-rounded-md t-pt-1 t-shadow-lg"
	>
		<div class=" t-flex t-rounded-md t-h-full  t-justify-between t-items-center t-bg-white t-px-4 sm:t-py-3 ">
			...
			>
				...
				>
				<i class="las la-download t-text-4xl t-font-semibold t-cursor-pointer"></i>
				</p>
			</div>
		</div>
	</div>
