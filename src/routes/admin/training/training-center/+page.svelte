...
<DeleteModal
	textContent={'If you delete this training venue, any corresponding training schedules and event schedules will also be deleted if they are associated with this training venue.'}
